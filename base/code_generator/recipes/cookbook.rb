...
# Chefspec
directory "#{cookbook_dir}/test/spec/unit/recipes" do
  recursive true
end

cookbook_file "#{cookbook_dir}/test/spec/spec_helper.rb" do
  action :create_if_missing
end

template "#{cookbook_dir}/test/spec/unit/recipes/default_spec.rb" do
